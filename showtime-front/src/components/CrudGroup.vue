<template>
  ...
  <div class="container">
    ...
    <div
      ...
      id="groupModal"
      tabindex="-1"
      aria-labelleBy="groupModalLabel"
      aria-hidden="true"
    >
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="modal-body">
              ...
              <div class="modal-body">
                <div class="input-group mb-3">
                  <span class="input-group-text">Cover_Picture</span>
                  <input
                    type="text"
                    class="form-control"
                    v-model="cover_picture"
                    required
                  />
                </div>
                <div class="modal-body">
...
export default {
  ...
  methods: {
    ...
    editGroupClick(group) {
      ...
      this.cover_picture = group.cover_picture;
